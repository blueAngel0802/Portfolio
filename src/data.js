export const data = {
  ...
  hero: {
    ...
    socials: [
      { label: "LinkedIn", href: "https://www.linkedin.com/in/james-moore-2940723a1/", icon: "in" },
  ...
  projects: {
    ...
    cards: [
      { title: "AI Resume Builder", desc: "Tailor resumes from a base resume using JD keywords, generating optimized experience bullets and exporting DOC/PDF.", badge: "Coming Soon" },
      { title: "CareerOS", desc: "Job tracking + browser extension to save applications, store job descriptions, and manage stages with an AI assistant.", badge: "Coming Soon" },
      { title: "Lead Scoring Automation", desc: "AI-driven lead qualification and prioritization with Airtable output and scoring logic improvements.", badge: "Coming Soon" }
    ]
  },
